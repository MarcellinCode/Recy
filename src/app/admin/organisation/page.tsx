...
export default function OrganizationDashboard() {
    ...
    const [activeTab, setActiveTab] = useState<'fleet' | 'opportunities' | 'marketplace'>('fleet');
    ...
    const handleBidSubmit = async (e: React.FormEvent) => {
        ...
        if (res.success) {
            ...
            showToast(res.error || "Erreur de soumission", "error");
        }
    };
                ...
                {activeTab === 'fleet' && (
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            ...
                            <MiniStatsCard label="Revenus Est." value={`${(subscriptions.length * 5).toFixed(1)}K`} icon={TrendingUp} color="text-emerald-500" />
                            <MiniStatsCard label="Alertes" value="2" icon={AlertTriangle} color="text-red-500" />
                        </div>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button 
                                        onClick={() => {
                                            ...
                                            if (name) showToast("Invitation envoyée !", "success");
                                        }}
                ...
                {activeTab === 'opportunities' && (
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {tenders.map((tender) => (
                                <div key={tender.id} className="bg-white dark:bg-zinc-900 p-8 rounded-[3rem] border border-gray-100 dark:border-zinc-800 shadow-xl hover:border-primary/30 transition-all flex flex-col justify-between">
                                    <div>
